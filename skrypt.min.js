...
!/*function(){var t=document.getElementsByTagName("body"),e=.1;window.onscroll=function(){[].slice.call(t).forEach(function(t,a){var n=-window.pageYOffset,s=t.offsetTop,i="50% "+(n-s)*e+"px";t.style.backgroundPosition=i})}}(),*/$(document).ready(function(){$(window).scroll(function(){$(this).scrollTop()>250?$(".sidebar").addClass("stick-sidebar"):$(".sidebar").removeClass("stick-sidebar")})}),$(document).ready(function(){$(window).scroll(function(){$(this).scrollTop()>100?$(".scrollup").fadeIn():$(".scrollup").fadeOut()}),$(".scrollup").click(function(){return $("html, body").animate({scrollTop:0},600),!1})}),function(){var t=document.querySelector(".hamburger");t.addEventListener("click",function(){document.querySelector(".nav").classList.toggle("nav-opened")},!1)}(),function(){"use strict";function t(t){t.addEventListener("click",function(t){t.preventDefault(),this.classList.contains("is-active")===!0?this.classList.remove("is-active"):this.classList.add("is-active")})}for(var e=document.querySelectorAll(".c-hamburger"),a=e.length-1;a>=0;a--){var n=e[a];t(n)}}(),$(document).ready(function(){$(".guide").setup_navigation()}),$.fn.setup_navigation=function(t){t=jQuery.extend({menuHoverClass:"show-menu"},t),$(this).attr("role","menubar").find("li").attr("role","menuitem");var e=$(this).find("> li > a");$(e).next("ul").attr("data-test","true").attr({"aria-hidden":"true",role:"menu"}).find("a").attr("tabIndex",-1),$(e).each(function(){$(this).next("ul").length>0&&$(this).parent("li").attr("aria-haspopup","true")}),$(e).hover(function(){$(this).closest("ul").attr("aria-hidden","false").find("."+t.menuHoverClass).attr("aria-hidden","true").removeClass(t.menuHoverClass).find("a").attr("tabIndex",-1),$(this).next("ul").attr("aria-hidden","false").addClass(t.menuHoverClass).find("a").attr("tabIndex",0)}),$(e).focus(function(){$(this).closest("ul").find("."+t.menuHoverClass).attr("aria-hidden","true").removeClass(t.menuHoverClass).find("a").attr("tabIndex",-1),$(this).next("ul").attr("aria-hidden","false").addClass(t.menuHoverClass).find("a").attr("tabIndex",0)}),$(this).find("a").last().keydown(function(e){(9==e.keyCode||9==e.which)&&$("."+t.menuHoverClass).attr("aria-hidden","true").removeClass(t.menuHoverClass).find("a").attr("tabIndex",-1)}),$(document).click(function(){$("."+t.menuHoverClass).attr("aria-hidden","true").removeClass(t.menuHoverClass).find("a").attr("tabIndex",-1)}),$(this).mouseleave(function(e){$("."+t.menuHoverClass).attr("aria-hidden","true").removeClass(t.menuHoverClass).find("a").attr("tabIndex",-1)}),$(this).click(function(t){t.stopPropagation()})},$(document).ready(function(){var t=$(".nav").offset().top,e=function(){var e=$(window).scrollTop();e>t?($(".nav").addClass("sticky"),$(".navjump").addClass("navjumpactive")):($(".nav").removeClass("sticky"),$(".navjump").removeClass("navjumpactive"))};e(),$(window).scroll(function(){e()})}),$(document).pjax("a[data-pjax]",".container",{fragment:".container"});baguetteBox.run('.gallery');
/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
/ __| | |/ __| |/ /  | / __|
